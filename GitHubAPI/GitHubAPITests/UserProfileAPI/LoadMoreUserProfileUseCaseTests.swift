...
class LoadMoreUserProfileUseCaseTests: XCTestCase {
    ...
    @discardableResult
    private func assertThat(_ loadAction: PaginatedLoadMoreAction, receive expectedResult: RemoteUserProfileLoader.Result, file: StaticString = #filePath, line: UInt = #line) -> PaginatedUserProfileResult? {
